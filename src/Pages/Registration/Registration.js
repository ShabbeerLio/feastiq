...
const Registration = () => {
    ...
    const signupSteps = [
        ...
        { name: "foodpreferences", type: "textarea", placeholder: "Food Preferences (Optional)" },
    ];
            ...
            <div className="Home-main">
                <div className="registration">
                    <div className="glass-container">
                        ...
                        <h5 className="title">
                            {mode === "signup" ? "Tell us about yourself!" : mode === "login" ? "Login" : ""}
                        </h5>
                        ...
                        <AnimatePresence mode="wait" custom={direction}>
                            ...
                            {/* SIGNUP FLOW */}
                            {mode === "signup" && !loadingStage && step > 0 && step <= signupSteps.length && (
                                <motion.div
                                    key={`login-${step}`}
                                    variants={slideVariants}
                                    initial="initial"
                                ...
                                >
                                    ...
                                    <form onSubmit={step === signupSteps.length ? handleGenerate : handleNext}>
                                        {(() => {
                                        ...
                                        <div className="btn-row">
                                            ...
                                            <button type="submit" className="next-btn">
                                                {step === signupSteps.length ? "Generate Plan" : "Next"}
                                            </button>
                                        </div>
                                    </form>
                                </motion.div>
                            ...
                            {/* LOGIN FLOW */}
                            {mode === "login" && !loadingStage && step > 0 && step <= loginSteps.length && (
                                <motion.div
                                    key={`login-${step}`}
                                    variants={slideVariants}
                                    initial="initial"
                                ...
                                >
                                    ...
                                    <form onSubmit={step === loginSteps.length ? handleLoginSubmit : handleNext}>
                                        {(() => {
